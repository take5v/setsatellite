...
from keras.layers import Input, Conv2D, Concatenate, MaxPooling2D, UpSampling2D, Reshape, core, Dropout
...
def get_unet(input_size, number_of_classes, number_of_channels=3):
